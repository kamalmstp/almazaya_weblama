...
<div class="content">
    <div class="content-row">
        <div class="content-left">
                ...
                <div class="new-article-frame"></div>
                <div class="boximage"  style="position: relative;">
                <div class="image_detail_news_frame">
                ...
                <div class="article">
                    ...
                    <div class="newarticle-ribbon">Artikel Terbaru</div>
                    <ul class="list-article">
                        ...
                        <li>
                            ...
                            ?>
                                <h2><a title="<?=$dt["title"]?>" href="<?=base_url($codebahasa.$dt["link_detail"].'/'.$dt["link_news"])?>"><?=$str?></a></h2>
                            </div>
                            <div class="description-list">
                                <?=$descriptionnya?>
                            </div>
