...
<div class="page-heading">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">
            <a href="<?=base_url("webadmin/".$url_module)?>">Joblist</a>
        </li>
        <li class="active">
            <a href="javascript:;">Edit Joblist </a>
        </li>
    </ul>
</div>
<div class="wrapper">
          ...
          <div class="panel-body">
            <div class="row">
              <div class="form-group col-lg-12">
                ...
                <label for="exampleInputEmail1">Batas Akhir</label>
                
                <?php
                $tanggal = "";
                if ($rec[0]['batas_akhir'] != ""){
                    $tanggal = explode("-",$rec[0]['batas_akhir']);
                    $tanggal = $tanggal[2]."-".$tanggal[1]."-".$tanggal[0];
                }
                ?>
                <input class="form-control datepicker" id="tanggal_lahir" value="<?=$tanggal?>" autocomplete="off" name="tanggal_lahir" minlength="2" type="text" required />
              </div>
              </div>
            </div>
          </div>
