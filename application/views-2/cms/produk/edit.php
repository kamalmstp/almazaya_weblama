...
<div class="wrapper">
  <div class="row">
    <form role="form" class="cmxform form-horizontal adminex-form" id="commentForm" method="POST" action=""  enctype="multipart/form-data">
      ...
      <input name="icon<?=$rowlang['id']?>" type="hidden" value="<?=$rec[$r]['icon']?>">
              ...
              <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  if(isset($status['form']['short_description'][$rowlang['id']]) AND $status['form']['short_description'][$rowlang['id']] != ""){
                    ...
                    $valueshortdescription = $rec[$r]['short_description'];
                  }
                  ?>
                ...
                <div class="form-group">
                  ...
                  if(isset($status['form']['product_detail'][$rowlang['id']]) AND $status['form']['product_detail'][$rowlang['id']] != ""){
                    ...
                    $valueproduct_detail = $rec[$r]['product_detail'];
                  }
                  ?>
                ...
                <div class="form-group">
                  ...
                  if(isset($status['form']['shipping_return'][$rowlang['id']]) AND $status['form']['shipping_return'][$rowlang['id']] != ""){
                    ...
                    $valueshipping_return = $rec[$r]['shipping_return'];
                  }
                  ?>
                  ...
                  <label for="exampleInputEmail1">List Image Produk</label>
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                      <div class="fileupload-new thumbnail" style="width: 500px; height: 200px;">
                          <?php if ($rec[$r]['pic'] != ""): ?>
                        <img src="<?=base_url('uploads/produk/'.$rec[$r]['pic'])?>" alt=""/>
                        <?php else: ?>
                ...
                <div class="form-group">
                  ...
                  <label for="exampleInputEmail1">Icon Produk</label>
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                      <div class="fileupload-new thumbnail" style="width: 500px; height: 200px; background: #EF4C27">
                          <?php if ($rec[$r]['icon'] != ""): ?>
                        <img src="<?=base_url('uploads/produk/'.$rec[$r]['icon'])?>" alt=""/>
                        <?php else: ?>
                        <img src="<?=base_url("assets/backend/images/no-image.png")?>" alt="" />
                        <?php endif ?>  
                      </div>
                ...
                <div class="form-group">
                  ...
                  if(isset($status['form']['linkyoutube'][$rowlang['id']]) AND $status['form']['linkyoutube'][$rowlang['id']] != ""){
                    ...
                    $valuelinkyoutube = $rec[$r]['linkyoutube'];
                  }
                  ?>
                ...
                <div class="form-group">
                  <div class="col-md-offset-2 col-md-8 lebarwidth">
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                      <div class="fileupload-new thumbnail" style="width: 500px; height: 200px;">
                          <?php if ($rec[$r]['pic2'] != ""): ?>
                        <img src="<?=base_url('uploads/produk/'.$rec[$r]['pic2'])?>" alt=""/>
                        <?php else: ?>
                        <img src="<?=base_url("assets/backend/images/no-image.png")?>" alt="" />
                        <?php endif ?>  
                      </div>
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  if(isset($status['form']['price']) AND $status['form']['price'] != ""){
                    ...
                    $valueprice = explode(".",strval($rec[0]['price']));
                  }
                  ?>
                  <label for="exampleInputEmail1">Price (*)</label>
                  <input class="input-price-key form-control justnumber" placeholder="Enter price" value="<?=$valueprice[0]?>" name="price" type="text" required="" />
                </div>
                <div class="form-group">
                  <?php
                  if(isset($status['form']['weight']) AND $status['form']['weight'] != ""){
                    ...
                    $valueweight = strval($rec[0]['weight']);
                  }
                  ?>
                  <label for="exampleInputEmail1">Weight / gram (*)</label>
                  <input class="input-weight-key form-control justnumber" placeholder="Enter Weight" value="<?=$valueweight?>" name="weight" type="text" required="" />
                </div>
              </div>
            </div>
          </div>
