...
<div class="page-heading">
    <h3>
        Hubungan Investor &raquo; <?=$hubungan_investor?>
    </h3>
    <ul class="breadcrumb">
        <li>
            <a href="#">Root</a>
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="text-right" id="nestable_list_menu" style="margin-bottom:20px;display:inline-block;">
        ...
        <a style="float:left;" class="btn btn-primary" href="<?=base_url('webadmin/hubungan_investor_report/'.$id_hubungan_investor.'/act/add')?>">
          <i class="fa fa-plus"></i>&nbsp Add New
        </a>
        <?php endif ?>
        &nbsp;&nbsp;<a class="btn btn-info" href="<?=base_url('webadmin/hubungan_investor')?>">
          <i class="fa fa-caret-left"></i>&nbsp Back to Hubungan Investor
        </a>
        ...
        <header class="panel-heading custom-tab dark-tab">
          <ul class="nav nav-tabs">
            <li <?=($statuspage == 'publish') ? 'class="active"' : '' ;?>>
              <a href="<?=base_url('/webadmin/hubungan_investor_report/'.$id_hubungan_investor)?>">
              Publish (<?=$count_publish?>) </a>
            </li>
            <li <?=($statuspage == 'draft') ? 'class="active"' : '' ;?>>
              <a href="<?=base_url('/webadmin/hubungan_investor_report/'.$id_hubungan_investor.'/draft')?>">
              Draft (<?=$count_draft?>) </a>
            </li>
            <li <?=($statuspage == 'trash') ? 'class="active"' : '' ;?>>
              <a href="<?=base_url('/webadmin/hubungan_investor_report/'.$id_hubungan_investor.'/trash')?>">
              Trash (<?=$count_trash?>) </a>
            </li>
          </ul>
        </header>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <a href="<?=base_url('webadmin/hubungan_investor_report/'.$id_hubungan_investor.'/act/'.$fungsidelete.'/'.$row['sister'])?>" class="btn btn-danger">Yes</a>
          ...
          <div class="modal fade draggable-modal" id="draft<?=$row['sister']?>" tabindex="-1" role="basic" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <a href="<?=base_url('webadmin/hubungan_investor_report/'.$id_hubungan_investor.'/act/'.$fungsiupdate.'/'.$row['sister'])?>" class="btn btn-danger">Yes</a>
                  <button type="button" class="btn default" data-dismiss="modal">Close</button>
                </div>
              </div>
              <!-- /.modal-content -->
            ...
            <li class="dd-item dd3-item" data-id="<?=$row['sister']?>">
              ...
              <div class="dd3-content">
                ...
                <div class="link-menu">
                  ...
                  <a class="btn-info link-table red btn btn-xs default" href="<?=base_url('webadmin/hubungan_investor_report/'.$id_hubungan_investor.'/act/movedraft/'.$row['sister'])?>">Restore to Draft</a>
                  ...
                  <?php else: ?>
                  <a href="<?=base_url('webadmin/hubungan_investor_report/'.$id_hubungan_investor.'/act/view/'.$row['sister'])?>" class="link-table green btn btn-xs default">
                  ...
                  ?>
                  <?php if ($permit->isupdate == 1): ?>
                  <a href="<?=base_url('webadmin/hubungan_investor_report/'.$id_hubungan_investor.'/act/edit/'.$row['sister'])?>" class="btn-primary link-table green btn btn-xs default">
                    <i class="fa fa-edit"></i> Edit
                  </a>
                  <a href="#draft<?=$row['sister']?>" data-toggle="modal" class="btn-info link-table blue btn btn-xs default">
                    <i class="fa fa-file-text"></i> Move to Publish
                  </a>
                  <?php else: ?>
                  <a href="<?=base_url('webadmin/hubungan_investor_report/'.$id_hubungan_investor.'/act/view/'.$row['sister'])?>" class="btn-info link-table green btn btn-xs default">
                    <i class="fa fa-eye"></i> View
                  </a>
                  <?php endif ?>
                  <?php if ($permit->isdelete == 1): ?>
                  <a href="#draggable<?=$row['sister']?>" data-toggle="modal" class="btn-danger link-table red btn btn-xs default">
                  ...
                  <div class="modal fade draggable-modal" id="draggable<?=$row2['id']?>" tabindex="-1" role="basic" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <a href="<?=base_url('webadmin/hubungan_investor_report/'.$id_hubungan_investor.'/act/'.$fungsidelete.'/'.$row2['id'])?>" class="btn btn-danger">Yes</a>
                          <button type="button" class="btn default" data-dismiss="modal">Close</button>
                        </div>
                      </div>
                      <!-- /.modal-content -->
                  ...
                  <div class="modal fade draggable-modal" id="draft<?=$row2['id']?>" tabindex="-1" role="basic" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <a href="<?=base_url('webadmin/hubungan_investor_report/'.$id_hubungan_investor.'/act/'.$fungsiupdate.'/'.$row2['id'])?>" class="btn btn-danger">Yes</a>
                          <button type="button" class="btn default" data-dismiss="modal">Close</button>
                        </div>
                      </div>
                      <!-- /.modal-content -->
                  ...
                  <li class="dd-item dd3-item" data-id="<?=$row2['id']?>">
                    ...
                    <div class="dd3-content">
                      ...
                      <div class="link-menu">
                        ...
                        <a href="<?=base_url('webadmin/hubungan_investor_report/'.$id_hubungan_investor.'/act/movedraft/'.$row2['id'])?>">Restore to Draft</a>
                        <a data-toggle="modal" style="color:red" href="#draggable<?=$row2['id']?>">Delete Permanently</a>
                        <?php else: ?>
                        <a href="<?=base_url('webadmin/hubungan_investor_report/'.$id_hubungan_investor.'/act/view/'.$row2['id'])?>" class="link-table green btn btn-xs default">
                          <i class="fa fa-eye"></i> View
                        </a>
                        <?php endif ?>
                        </div>
                        ...
                        ?>
                        <?php if ($permit->isupdate == 1): ?>
                        <a href="<?=base_url('webadmin/hubungan_investor_report/'.$id_hubungan_investor.'/act/edit/'.$row2['id'])?>" class="btn-primary link-table green btn btn-xs default">
                          <i class="fa fa-edit"></i> Edit
                        </a>
                        ...
                        <?php else: ?>
                        <a href="<?=base_url('webadmin/hubungan_investor_report/'.$id_hubungan_investor.'/act/view/'.$row2['id'])?>" class="btn-info link-table green btn btn-xs default">
                          <i class="fa fa-eye"></i> View
                        </a>
                        <?php endif ?>
                        <?php if ($permit->isdelete == 1): ?>
