            ...
            <div class="form">
              <div class="col-md-12">
                  ...
                  <label for="exampleInputEmail1">Image List (*)</label>
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                      <div class="fileupload-new thumbnail" style="width: 500px; height: 200px;">
                        <?php if ($rec[$r]['pic'] != ""): ?>
                        <img src="<?=base_url('uploads/video/'.$rec[$r]['pic'])?>" alt=""/>
                        <?php else: ?>
                ...
                <div class="form-group">
                  ...
                  <input lang="<?=$rowlang['id']?>" <?=$required?> class="input-title-key form-control" placeholder="Enter link youtube" value="<?=$valueyoutube?>" name="youtube[<?=$rowlang['id']?>]" minlength="2" type="text" />
                  ex : https://www.youtube.com/watch?v=yx1VMd6jHzo
                </div>
                <div class="form-group" style="display: none;">
                  <div class=" col-md-8 no-padding-left lebarwidth">
                  <label for="exampleInputEmail1">Image Detail (*)</label>
                    ...
                    <br/>
                    <span class="label label-danger ">NOTE!</span>
                    <span>Witdh : 790px - Height : 400px</span>
                  </div>
                </div>
        ...
        $('.input-title-key').blur(function(){
            ...
            if ($(this).val() != ""){
                $.ajax({
                    ...
                    dataType: 'html',
                    async:false,
                    data: { 'lang': $(this).attr("lang"),'title': $(this).val(),'table': 'video'},
                    beforeSend: function () {
