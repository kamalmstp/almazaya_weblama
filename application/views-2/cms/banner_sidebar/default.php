  ...
  <div class="row">
    <div class="col-lg-12">
      <section class="panel">
        ...
        if ($jumlahdata != 0) {
        ?>
        <div class="dd" <?=($statuspage == 'publish' and $permit->isupdate == 1) ? 'id="nestable_list_3"' : '' ;?> lang="banner_sidebar">
          <ol class="dd-list">
          <?php
            $urut = 0;
            foreach ($rec as $row) {
          ...
          <?php endif ?>
            <li class="dd-item dd3-item" data-id="<?=$row['sister']?>">
              ...
              <div class="dd3-content" style="padding-top: 15px;">
                <div class="<?=$cssclass?>">
                  <?php
                  ...
                  <div class="wrap-img-nestable">
                    <img src="<?=base_url('assets/images/sidebar/'.$row['thumb'])?>" alt="" >  
                  </div>
                </div>
                <div class="link-menu">
                  <?php
