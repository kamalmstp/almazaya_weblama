...
<div class="page-heading">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">
            <a href="<?=base_url('webadmin/'.$url_module.'')?>">Produk &amp; Layanan (Consumer Banking) &raquo; List Produk &amp; Service</a>
        </li>
    </ul>
  </div>
<div class="wrapper">
  ...
  <div class="row">
    <div class="col-lg-12">
      <section class="panel">
        ...
        if ($jumlahdata != 0) {
        ?>
        <div class="dd" <?=($statuspage == 'publish' and $permit->isupdate == 1) ? 'id="nestable_list_3"' : '' ;?> lang="list_produk_service">
          <ol class="dd-list">
          <?php
            $urut = 0;
            foreach ($rec as $row) {
