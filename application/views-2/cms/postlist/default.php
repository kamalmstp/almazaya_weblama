      ...
      <section class="panel">
        ...
        <form role="form" class="form-inline" method="GET">
            <div class="form-group">
                ...
                <input name="keyword" type="text" placeholder="Search Title" id="exampleInputEmail2" <?php if (isset($_GET['cari'])){ ?> value="<?=$_GET['keyword']?>" <?php } ?> class="form-control">
            </div>
            
            <input class="btn btn-primary" type="submit" value="Search">
            <a class="btn btn-primary" href="<?=base_url('/webadmin/'.$url_module)?>">Show All</a>
            <a class="btn btn-primary" href="<?=base_url('/webadmin/'.$url_module.'/?show=nopagination')?>">Show All Without Pagination</a>
        </form>
        <br />
            ...
            <li class="dd-item dd3-item" data-id="<?=$row['sister']?>" data-pos="<?=$sorting?>" data-urut="<?=$urutan?>" data-limit="<?=$limit?>">
              ...
              <div class="dd3-content">
                <div class="<?=$cssclass?>">
                  ...
                  ?>
                |
                  <b  class="btn-warning link-table green btn btn-xs default"><?=$row['title_cat']?></b>
                  <?php
                    if ($row["hidden"] == 1){
                        ?>
                ...
                <div class="link-menu">
                  <a class="btn-warning link-table green btn btn-xs default" href="<?=base_url('webadmin/'.$url_module.'/act/adsbanner/'.$row['sister'])?>" class="link-table green btn btn-xs default">
                    <i class="fa fa-picture-o"></i> Ads Banner
                  </a>
                  <?php if ($permit->isupdate == 1): ?>
