...
<div class="page-heading">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">
            <a href="<?=base_url("webadmin/".$url_module)?>">Management List</a>
        </li>
        <li class="active">
            <a href="javascript:;">Add Management List</a>
        </li>
    </ul>
</div>
<div class="wrapper">
            ...
            <div class="row">
              <div class="form-group col-lg-12">
                ...
                <select name="cat" class="form-control" required>
                    <option value=""> -- Choose Management Category -- </option>
                    <?php
                    foreach ($pages as $ct){
                    ?>
                    <option value="<?=$ct["sister"]?>"><?=$ct["title"]?></option>
                    <?php
                    }
                    ?>
                </select>
          ...
          <div class="panel-body">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <input lang="<?=$rowlang['id']?>" class="input-title-key form-control" placeholder="Enter your title" name="position[<?=$rowlang['id']?>]" required type="text" />
              </div>
              <div class="form-group">
                  <?php
