...
<!-- Mirrored from techlinqs.com/html/school-0.2/home-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Mar 2017 03:49:30 GMT -->
<head>
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<meta name="author" content=""/>
<title>SDIT ISLAM AL UMAR <?php if (isset($meta_title)){ ?> - <?=$meta_title?><?php } ?></title>
	...
	<header id="header" class="main-header sticky-1">
		<div class="container">
			...
			<div class="logo-holder">
				<strong><a href="<?=base_url()?>"><img src="<?=base_url("assets/images/logo.png")?>" alt="logo"></a></strong>
			</div>
			<!-- logo -->
            <!-- Navigation -->
