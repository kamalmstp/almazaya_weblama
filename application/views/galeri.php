                    ...
                    ?>
                        ...
                        <div class="col-sm-3 list_post">
							<div class="post_featured">
								<div class="post_thumb" data-image="<?=base_url("uploads/galeri/".$dt["pic"])?>" data-title="<?=$dt["title"]?>">
									<a data-fancybox="images" data-caption="<?=$dt["title"]?>" class="hover_icon hover_icon_link" href="<?=base_url("uploads/galeri/".$dt["pic"])?>"   rel="magnific"><img src="<?=base_url("uploads/galeri/thumb_".$dt["pic"])?>" alt="<?=$dt["title"]?>"></a>
								</div>
							</div>
