<div class="modal-header">
                                ...
                                <div class="error-form">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="label_address" class="form-control label_address" required="" value="<?php if (isset($alamat[0]["label_address"])){ if ($alamat[0]["label_address"] == ""){echo $fullname; }else{echo $alamat[0]["label_address"]; }}?>" id="inputPassword3" placeholder="Address Label"/>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="province" class="form-control province" required="">
                                            <option value="">-- Select <?=$this->lang->line('province');?> --</option>
                                            <?php
                                            foreach ($rec as $dt){
                                                $selected = "";
                                  ...
                                  <div class="modal-footer">
                                    <input type="submit" value="<?=$this->lang->line('submit');?>" class="submit">
                                  </div>
                                </div>
