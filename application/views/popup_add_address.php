<div class="modal-header">
                                  ...
                                  <h4 class="modal-title"><?=$this->lang->line('ADDADDRESS');?></h4>
                                </div>
                                <div class="modal-body">
                                <div class="error-form">
                                    
                                </div>
                                  <form class="form-horizontal add_address" role="form" action="" method="POST">
                                  ...
                                  <div class="form-group">
                                    <label class="col-sm-2 control-label" for="inputPassword3"><?=$this->lang->line('ADDRESSLABEL');?></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="label_address" class="form-control label_address" required="" value="<?php if (isset($alamat[0]["label_address"])){ echo $alamat[0]["label_address"]; }?>" id="inputPassword3" placeholder="Address Label"/>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    <label class="col-sm-2 control-label" for="inputPassword3"><?=$this->lang->line('Phone');?></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="telepon" class="form-control telepon justnumber" required="" value="<?php if (isset($alamat[0]["telepon"])){ echo $alamat[0]["telepon"]; }?>" id="Telepon" placeholder="Telepon"/>
                                    </div>
                                  </div>
                                  <div class="modal-footer">
                                    <input type="submit" value="<?=$this->lang->line('submit');?>" class="btn btn-default">
                                  </div>
                                </div>
