...
<div class="page-heading">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">
            <a href="javascript:;">Add Joblist</a>
        </li>
    </ul>
</div>
<div class="wrapper">
          ...
          <div class="panel-body">
            <div class="row">
              <div class="form-group col-lg-12">
                ...
                <input class="form-control datepicker" id="tanggal_lahir" autocomplete="off" name="tanggal_lahir" minlength="2" type="text" required />
              </div>
              </div>
            </div>
          </div>
