            ...
            <div class=" form">
              ...
              <div class="col-lg-12">
                ...
                <div class="form-group ">
                  ...
                  ?>
                  <label for="exampleInputEmail1">Page(s) with modul records </label>  
                  <select name="record" class="form-control" data-placeholder="Select...">
                    <option value=''>Choose Record</option>
                      <?php
                      foreach ($menu_record as $row) {
                        if ($row['id'] == $rec[0]['record']) {
                          $select = "selected";
                        } else {
                          $select = "";
                        }
