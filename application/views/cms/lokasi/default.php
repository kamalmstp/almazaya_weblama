            ...
            <div class="form">
              <div class="col-md-12">
                <div class="form-group">
                  <?php
                  if(isset($status['form']['address'][$rowlang['id']]) AND $status['form']['address'][$rowlang['id']] != ""){
                    $valueaddress = $status['form']['address'][$rowlang['id']];
                  }else{
                    $valueaddress = '';
                    if (count($rec) > 0){
                        
                        if (count($rec) > 0){
                            $valueaddress = $rec[$r]['address'];
                        }else{
                            $valueaddress = '';
                        }
                    }
                  ...
                  <input lang="<?=$rowlang['id']?>" class="input-address-key form-control" placeholder="Enter your address" value="<?=$valueaddress?>" name="address[<?=$rowlang['id']?>]" minlength="2" type="text" />
                </div>
