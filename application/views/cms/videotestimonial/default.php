  ...
  <div class="row">
    <div class="col-sm-12">
      ...
      <div class="wrap-btn-add">
        <a class="btn btn-primary" href="<?=base_url('webadmin/videotestimonial/act/add')?>">
        ...
        <header class="panel-heading custom-tab dark-tab">
          <ul class="nav nav-tabs">
            <li <?=($statuspage == 'publish') ? 'class="active"' : '' ;?>>
              <a href="<?=base_url('/webadmin/videotestimonial/')?>">
              Publish (<?=$count_publish?>) </a>
            </li>
            <li <?=($statuspage == 'draft') ? 'class="active"' : '' ;?>>
              <a href="<?=base_url('/webadmin/videotestimonial/draft')?>">
              Draft (<?=$count_draft?>) </a>
            </li>
            <li <?=($statuspage == 'trash') ? 'class="active"' : '' ;?>>
              <a href="<?=base_url('/webadmin/videotestimonial/trash')?>">
              Trash (<?=$count_trash?>) </a>
            </li>
          </ul>
        </header>
            ...
            <tbody>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <a href="<?=base_url('webadmin/videotestimonial/act/'.$fungsidelete.'/'.$row['sister'])?>" class="btn btn-danger">Yes</a>
              ...
              <div class="modal fade draggable-modal" id="draft<?=$row['sister']?>" tabindex="-1" role="basic" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <a href="<?=base_url('webadmin/videotestimonial/act/'.$fungsiupdate.'/'.$row['sister'])?>" class="btn btn-danger">Yes</a>
                      <button type="button" class="btn default" data-dismiss="modal">Close</button>
                    </div>
                  </div>
                  <!-- /.modal-content -->
              ...
              <tr>
                ...
                <td align="right">
                  ...
                  <a class="btn btn-warning" href="<?=base_url('webadmin/videotestimonial/act/movedraft/'.$row['sister'])?>">Restore to Draft</a>
                  <a class="btn btn-danger" data-toggle="modal" href="#draggable<?=$row['sister']?>">Delete Permanently</a>
                  <?php else: ?>
                  <a href="<?=base_url('webadmin/videotestimonial/act/view/'.$row['sister'])?>" >
                  ...
                  ?>
                  <?php if ($permit->isupdate == 1): ?>
                  <a class="btn btn-info" href="<?=base_url('webadmin/videotestimonial/act/edit/'.$row['sister'])?>" >
