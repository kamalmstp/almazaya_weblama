              ...
              <div class="col-lg-12">
                <div class="form-group" style="padding-bottom: 25px;">
                    ...
                    if(isset($status['form']['title']) AND $status['form']['title'] != ""){
                        ...
                        $valuetitle = $rec[0]['title'];
                    }
                    ?>
                    <input class="input-title-key form-control" placeholder="Enter Bank Name" value="<?=$valuetitle?>" name="title" type="text" />
                </div>
              </div>
              <div class="col-lg-12">
                <div class="form-group" style="padding-bottom: 25px;">
                    ...
                    <?php
                    if(isset($status['form']['bank_account_number']) AND $status['form']['bank_account_number'] != ""){
                        $valueab = $status['form']['bank_account_number'];
                    }else{
                        $valueab = $rec[0]['bank_account_number'];
                    }
                    ?>
                    <input class="input-account-number-key form-control justnumber" placeholder="Enter Bank Account Number" value="<?=$valueab?>" name="bank_account_number" type="text" />
                </div>
              </div>
              <div class="col-lg-12">
                <div class="form-group" style="padding-bottom: 25px;">
                    ...
                    <?php
                    if(isset($status['form']['bank_account_name']) AND $status['form']['bank_account_name'] != ""){
                        $valueabn = $status['form']['bank_account_name'];
                    }else{
                        $valueabn = $rec[0]['bank_account_name'];
                    }
                    ?>
                    <input class="input-account-name-key form-control justnumber" placeholder="Enter Bank Account Name" value="<?=$valueabn?>" name="bank_account_name" type="text" />
                </div>
              </div>
              ...
              <?php 
                ...
                <div class="col-lg-12" style="padding-bottom: 20px;">
                  <div class="form-group">
                      <?php
                      if(isset($status['form']['content']) AND $status['form']['content'] != ""){
                        $valuecontent = $status['form']['content'];
                      }else{
                        $valuecontent = $rec[$r]["description"];
                      }
                      ?>
                      <label for="exampleInputEmail1">Content <?=$rowlang["title"]?></label>
