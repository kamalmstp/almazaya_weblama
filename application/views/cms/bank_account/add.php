            ...
            <div class=" form">
              ...
              <div class="col-lg-12">
                <div class="form-group" style="padding-bottom: 25px;">
                    ...
                    <input class="input-title-key form-control" placeholder="Enter Bank Name" value="" name="title" minlength="2" type="text" />
                </div>
              </div>
              <div class="col-lg-12">
                <div class="form-group" style="padding-bottom: 25px;">
                    <label for="exampleInputEmail1">Bank Account Number</label>
                    <input class="input-account-number-key form-control" placeholder="Enter Bank Account Number" value="" name="bank_account_number" type="text" />
                </div>
              </div>
              <div class="col-lg-12">
                <div class="form-group" style="padding-bottom: 25px;">
