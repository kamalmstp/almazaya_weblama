          ...
          <div class="panel-body">
            <div class="row">
              <div class="form-group col-md-12">
                ...
                <input class="input-title-key form-control" placeholder="Enter your title" name="mata_uang" value="<?=$rec[0]['title']?>" type="text" required />
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-12">
                <label for="exampleInputEmail1">Indicative Special Rate Jual (*)</label>
                <input class="input-title-key form-control" name="indicative_special_rate_jual" type="text" value="<?=$rec[0]['indicative_special_rate_jual']?>" />
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-12">
                <label for="exampleInputEmail1">Indicative Special Rate Beli (*)</label>
                <input class="input-title-key form-control" name="indicative_special_rate_beli" type="text" value="<?=$rec[0]['indicative_special_rate_beli']?>" />
              </div>
            </div>
              <hr />
            <div class="row">
              <div class="form-group col-md-12">
                ...
                <input class="input-title-key form-control" name="ttcounter_jual" type="text" value="<?=$rec[0]['ttcounter_jual']?>" />
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-12">
                <label for="exampleInputEmail1">TTCounter Beli (*)</label>
                <input class="input-title-key form-control" name="ttcounter_beli" type="text" value="<?=$rec[0]['ttcounter_beli']?>" />
              </div>
            </div>
              <hr />
            <div class="row">
              <div class="form-group col-md-12">
                ...
                <input class="input-title-key form-control" name="bank_notes_jual" type="text" value="<?=$rec[0]['bank_notes_jual']?>" />
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-12">
                <label for="exampleInputEmail1">Bank Notes Beli (*)</label>
                <input class="input-title-key form-control" name="bank_notes_beli" type="text" value="<?=$rec[0]['bank_notes_beli']?>" />
              </div>
            </div>
          </div>
        </section>
