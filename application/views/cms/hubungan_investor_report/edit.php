...
<div class="page-heading">
    <h3>
        Hubungan Investor &raquo; <?=$hubungan_investor?> &raquo; Edit
    </h3>
    <ul class="breadcrumb">
        <li>
            <a href="#">Root</a>
        ...
        <section class="panel">
          ...
          <div class="panel-body">
            <div class="row">
              ...
              <div class="form-group col-md-12">
                  <?php
                  if(isset($status['form']['file'][$rowlang['id']]) AND $status['form']['file'][$rowlang['id']] != ""){
                    $valuecontent = $status['form']['file'][$rowlang['id']];
                  }else{
                    $valuecontent = $rec[$r]['file'];
                  }
                  ?>
                  <label for="exampleInputEmail1">File</label>
                  <div><a target="_blank" href="<?=base_url("uploads/hubungan_investor/".$valuecontent)?>"><?=$valuecontent?></a></div>
