        ...
        <div class="panel-body">
          <div class="adv-table">
            ...
            <tbody>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <a type="button" class="btn btn-warning" href="<?=base_url('webadmin/'.$url_module.'/act/'.$fungsi.'/'.$row['id'])?>"> Confirm</a>
              ...
              <tr>
                <td><?=$row['name']?> / <?=$row['sebagai']?></td>
                <td><?=$row['testimonial']?></td>
                <td align="right">
                  <?php
                  if ($statuspage == 'trash') {
                  ?>
                  <a class="btn btn-info" href="<?=base_url('webadmin/'.$url_module.'/act/restore/'.$row['id'])?>">Restore</a>

                  <a class="btn btn-danger" data-toggle="modal" href="#konfirmasi<?=$row['id']?>">Delete Permanently</a>
                  <?php
                  } else {
                  ?>
                  <a href="<?=base_url('webadmin/'.$url_module.'/act/edit/'.$row['id'])?>" class="btn btn-warning">
