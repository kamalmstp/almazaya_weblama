          ...
          <div class=" form">
            <form role="form" class="cmxform form-horizontal adminex-form" id="commentForm" method="POST" action=""  enctype="multipart/form-data">
              ...
              <div class="col-lg-9">
                ...
                <div class="form-group">
                  <?php
                  if(isset($status['form']['sebagai']) AND $status['form']['sebagai'] != ""){
                    $valuesebagai = $status['form']['sebagai'];
                  }else{
                    $valuesebagai = $rec['sebagai'];
                  }
                  ?>
                  <label for="name">Sebagai (*)</label>
                  <input class=" form-control" placeholder="ex : Guru, Murid, Kepala Sekolah" value="<?=$valuesebagai?>" id="sebagai" name="sebagai" minlength="2" type="text" />
                </div>
                <div class="form-group">
                  <?php
                  if(isset($status['form']['description']) AND $status['form']['description'] != ""){
                    ...
                    $valuedescription = $rec['testimonial'];
                  }
                  ?>
