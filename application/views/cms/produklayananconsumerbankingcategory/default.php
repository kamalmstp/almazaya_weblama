...
<div class="page-heading">
    <h3>
        Produk &amp; Layanan (Consumer Banking) &raquo; Category
    </h3>
    <ul class="breadcrumb">
        <li>
            <a href="#">Root</a>
        ...
        <li class="active">
            <a href="<?=base_url('webadmin/'.$url_module.'')?>">Produk &amp; Layanan (Consumer Banking) &raquo; Category</a>
        </li>
    </ul>
  </div>
<div class="wrapper">
  ...
  <div class="row">
    <div class="col-lg-12">
      <section class="panel">
        ...
        if ($jumlahdata != 0) {
        ?>
        <div class="dd" <?=($statuspage == 'publish' and $permit->isupdate == 1) ? 'id="nestable_list_3"' : '' ;?> lang="produklayananconsumerbanking_category">
          <ol class="dd-list">
          <?php
            $urut = 0;
            foreach ($rec as $row) {
          ...
          <?php endif ?>
            <li class="dd-item dd3-item" data-id="<?=$row['sister']?>">
              ...
              <div class="dd3-content">
                <div class="<?=$cssclass?>" style="width:unset;">
                  <?php
                  ...
                  if(strlen($row['title'])<= 55){
                    ...
                    echo substr($row['title'], 0, 55)."... ( ".$row['link']." )";
                  }
                  ?>
                ...
                <div class="link-menu">
                  ...
                  <a class="btn-info link-table red btn btn-xs default" href="<?=base_url('webadmin/'.$url_module.'/act/movedraft/'.$row['sister'])?>">Restore to Draft</a>
