                  ...
                  <label for="exampleInputEmail1">Image</label>
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                      <div class="fileupload-new thumbnail" style="width: 500px; height: 200px;">
                          <?php if ($rec[$r]['pic'] != ""): ?>
                        <img src="<?=base_url('uploads/graphic_orac/'.$rec[$r]['pic'])?>" alt=""/>
                        <?php else: ?>
                    ...
                    <span>Witdh : 122px - Height : 122px</span>
                  </div>
                </div>
                
                <div class="form-group">
                  <?php
                  if(isset($status['form']['orac'][$rowlang['id']]) AND $status['form']['orac'][$rowlang['id']] != ""){
                    $valueorac = $status['form']['orac'][$rowlang['id']];
                  }else{
                    $valueorac = $rec[0]['orac'];
                  }
                  ?>
                  <label for="exampleInputEmail1">Orac</label>
                  <input lang="<?=$rowlang['id']?>" class="input-orac-key form-control" placeholder="Enter orac" value="<?=$valueorac?>" name="orac[<?=$rowlang['id']?>]" minlength="2" type="text" />
                </div>
