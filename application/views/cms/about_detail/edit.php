...
<div class="wrapper">
  <div class="row">
    <form role="form" class="cmxform form-horizontal adminex-form" id="commentForm" method="POST" action=""  enctype="multipart/form-data">
      ...
      <input name="oldicon<?=$rowlang['id']?>" type="hidden" value="<?=$rec[$r]['pic2']?>">
              ...
              <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                      <div class="fileupload-new thumbnail" style="width: 51px; height: 51px; background: #ccc;">
                          <?php
                            if($rec[$r]['pic2'] != ""){
                            ?>
                            <img src="<?=base_url("uploads/about_detail/".$rec[$r]['pic2'])?>" alt="" />
                            <?php
                            }else{
                            ?>
                      ...
                      <div>
                        <span class="btn btn-default btn-file" style="margin-left:0px;margin-right:10px">
                          ...
                          <span class="fileupload-exists"><i class="fa fa-undo"></i> Change Icon</span>
                    ...
                    <span>Witdh : 51px - Height : 51px</span>
                ...
                <div class="form-group" style="display: none;">
                  <?php
                  if(isset($status['form']['content_curricullum'][$rowlang['id']]) AND $status['form']['content_curricullum'][$rowlang['id']] != ""){
                    $valuecontent_curricullum = $status['form']['content_curricullum'][$rowlang['id']];
                  }else{
                    $valuecontent_curricullum = $rec[$r]['content_curricullum'];
                  }
                  ?>
                  <label for="exampleInputEmail1">Content Curricullum</label>
                  <textarea class="texttiny" name="content_curricullum[<?=$rowlang['id']?>]" rows="6"><?=$valuecontent_curricullum?></textarea>
                </div>
                <div class="form-group" style="display: none;">
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                      <div class="fileupload-new thumbnail" style="width: 500px; height: 200px;">
                          <?php
                            if($rec[$r]['pic'] != ""){
                            ?>
                            <img src="<?=base_url("uploads/level/".$rec[$r]['pic'])?>" alt="" />
                            <?php
                            }else{
                            ?>
                            <img src="<?=base_url("assets/backend/no-image.png")?>" alt="" />
                    ...
                    <br/>
                    <span class="label label-danger ">NOTE!</span>
                    <span>Witdh : 980px - Height : 658px</span>
