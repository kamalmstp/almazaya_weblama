            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
                ...
                if(isset($status['form']['oleh'][$rowlang['id']]) AND $status['form']['oleh'][$rowlang['id']] != ""){
                  ...
                  $valueoleh = $rec[$r]['oleh'];
                }
                ?>
                <label for="exampleInputEmail1">Dibuat Oleh (*)</label>
                <input lang="<?=$rowlang['id']?>" class="input-dibuat-key form-control" placeholder="Dibuat Oleh" value="<?=$valueoleh?>" name="oleh[<?=$rowlang['id']?>]" type="text" />
              </div>
              ...
              <div class="form-group">
                <div class="col-md-offset-3 col-md-6 lebarwidth">
                  <div class="fileupload fileupload-new" data-provides="fileupload">
                    ...
                    if($rec[$r]['pic'] != ""){
                    ?>
                    <img src="<?=base_url("uploads/pengumuman/".$rec[$r]['pic'])?>" alt="" />
                    <?php
                    }else{
                    ?>
