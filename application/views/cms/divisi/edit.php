            ...
            <form role="form" class="cmxform form-horizontal adminex-form" id="commentForm" method="POST" action=""  enctype="multipart/form-data">
              ...
              <div class="col-lg-12">
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <input class=" form-control" placeholder="Title Divisi" value="<?=$valuetitle?>" id="ctitle" name="title" minlength="2" type="text" required />
                  </div>
                </div>
              </div>
              <div class="row">
                                ...
                                <td>
                                  <div class="icheck ">
                                    ...
                                    <div class="flat-blue">
                                      ...
                                      <label for="update<?=$row2['id']?>">Update
