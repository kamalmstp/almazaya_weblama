  ...
  <div class="row">
    <div class="col-sm-12">
      ...
      <div class="wrap-btn-add">
        <a class="btn btn-primary" href="<?=base_url('webadmin/divisi/act/add')?>">
            ...
            <tbody>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <a type="button" class="btn btn-warning" href="<?=base_url('webadmin/divisi/act/'.$fungsi.'/'.$row['id'])?>"> Confirm</a>
              ...
              <tr>
                ...
                <td align="right">
                  ...
                  if ($statuspage == 'trash') {
                  ?>
                  <a class="btn btn-info" href="<?=base_url('webadmin/divisi/act/restore/'.$row['id'])?>">Restore</a>

                  <a class="btn btn-danger" data-toggle="modal" href="#konfirmasi<?=$row['id']?>">Delete Permanently</a>
                  <?php
                  } else {
                  ?>
                  <a href="<?=base_url('webadmin/divisi/act/edit/'.$row['id'])?>" class="btn btn-warning">
