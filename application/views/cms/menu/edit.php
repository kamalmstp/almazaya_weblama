              ...
              <div class="col-lg-10">
                ...
                <div class="row">
                  <div class="col-md-6">
                      ...
                      <input class="form-control justnumber" <?php if ($rec["module"] == 1){ ?> required="" <?php } ?> placeholder="Enter your width" value="<?=$valuewidth?>" id="width" name="width" type="text" />
                    </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <input class="form-control justnumber" <?php if ($rec["module"] == 1){ ?> required="" <?php } ?> placeholder="Enter your height" value="<?=$valueheight?>" id="height" name="height" type="text" />
