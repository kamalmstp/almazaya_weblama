...
class My_purchase extends Base_Controller {
    ...
    public function index(){
        ...
        $query = 'SELECT *,DATE_FORMAT(crdate,"%d/%m/%Y") AS datenya  FROM cart WHERE uid_user = '.$data_session["login_user"]["eternaleaf_user_login"].' ORDER BY crdate DESC LIMIT '.$start.','.$limit;
        $query_count = 'SELECT * FROM cart WHERE uid_user = '.$data_session["login_user"]["eternaleaf_user_login"].' ORDER BY crdate DESC';
        ...
        $this->load->view('mypurchase',$this->data);
    }
