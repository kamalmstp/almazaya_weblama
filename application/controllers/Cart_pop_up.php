...
class Cart_pop_up extends Base_Controller {
    ...
    public function index(){
        ...
        $query = 'SELECT a.uid as id_detail,IFNULL(sum(a.qty),0) as totalnya,b.title,b.pic,b.price,(b.price * sum(a.qty)) as totalharga FROM temporary_cart_detail a LEFT JOIN produk b ON a.uid_produk=b.sister WHERE a.uid_temporary_cart = '.$session_data['id_cart'].' AND b.idlanguage=1 GROUP BY a.uid_produk';
...
//        print_r($top);
        ...
        $this->data["codebahasa"] = "";
        if(isset($_GET["lang"])){
            $this->data["codebahasa"] = $_GET["lang"];
        }
